...
% Pour les ellipses, diamands,...
\usetikzlibrary{shapes,arrows}

% Pour les anneaux olympiques
\usetikzlibrary{calc}
...
\section{Des figures aux illustrations}

	\subsection{Les anneaux olympiques}
	...
	\subsection{Beaucoup de c\oe urs}
	...
	\begin{center}
		...
		% Dessin
		\coeur[shift={(1.3,2)},ball color=red,scale=0.85]
		\coeur[shift={(-1.5,1.8)},ball color=orange,scale=0.65,rotate=35]
		\coeur[shift={(3.2,1.6)},ball color=magenta,scale=0.6,rotate=-20]
		\coeur[shift={(4.8,2.5)},ball color=green,scale=0.65,rotate=-25]
		\coeur[shift={(6.9,2.1)},ball color=yellow,scale=0.75,rotate=10]
		\end{tikzpicture}
	\end{center}
